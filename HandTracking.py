# =========================
# Two-Hand Gesture Mouse (Headless / No OpenCV Window)
# - One hand = cursor
...
def main():
    ...
    try:
        while True:
            ...
            # (No imshow / waitKey here for headless run)
        ...
        if left_down:
            pyautogui.mouseUp()
        grab.release()
        # No cv2.destroyAllWindows() needed since we never opened one
